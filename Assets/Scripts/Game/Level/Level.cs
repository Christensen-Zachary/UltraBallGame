...
public class Level
{
    ...
    public Level(int levelNum, int numberOfDivisions, List<Brick> bricks, List<Ball> balls, int health, int extraBallPowerUpCount, int floorBricksCount, int fireBallsPowerUpCount)
    {
        LevelNum = levelNum;
